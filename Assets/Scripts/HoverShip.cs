...
namespace Buttermilch {
    ...
    public class HoverShip : MonoBehaviour {
        ...
        [SerializeField] private float _fwdMaxSpeed = 2000f;
        ...
        /// </summary>
        /// <returns></returns>
        private bool IsAccelerating() => (Input.GetKey(KeyCode.W) == true);

        /// <summary>
        /// Checks if any input is pressed for boosting.
        /// </summary>
        /// <returns></returns>
        private bool IsBoosting() => (Input.GetKey(KeyCode.Space) && _canBoost);
